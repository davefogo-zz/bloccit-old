...
RSpec.describe TopicsController, type: :controller do
  ...
  context "moderator user" do
    before do
      user = User.create!(name: 'Moderator', email: 'moderator@example.com', password: 'password', role: :moderator)
      create_session(user)
    end
    ...
    describe "PUT update" do
      it "updates topic with expected attributes" do
        new_name = "New name for topic"
        new_description = "New description for topic"
